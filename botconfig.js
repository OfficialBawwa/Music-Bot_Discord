module.exports = {
  ...
  Website: process.env.Website || "https://0.0.0.0/", //Website where it was hosted at includes http or https || Use "0.0.0.0" if you using Heroku
  
  Presence: {
    status: "online", // You can show online, idle, and dnd
    name: "Bawsfm.com", // The message shown
